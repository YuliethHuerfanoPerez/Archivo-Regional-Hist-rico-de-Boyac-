                        ...
                        <li>
							<li class="nav-item dropdown">
								...
								<ul class="dropdown-menu" style="background: #27AE60 none repeat scroll 0 0 !important;">
								  <li><a class="page-scroll dropdown-item" href="update-passwordPersonal.php">Cambiar contraseña</a></li>
                        ...
                        <div class="t-box">
                            ...
                            <form action="" method="POST">
                                <div class="ajax-hidden">
                                    ...
                                    <div data-wow-delay=".1s" class="col-xs-6 col-sm-6 col-sm-offset-3 form-group wow fadeInUp animated">
                                        <label for="c_password" class="sr-only">Cambiar contraseña</label>
                                        <input type="password" placeholder="Nueva contraseña" name="passwordnew" class="form-control" id="passwordnew"  required>
                                    </div>
...
<?php
include '../logic/ControlPasswPersonal.php';
#session_start();
$controlIngreso= new controlpasswPersonal();
$user = $_POST['user'];
...
if(empty($password) || empty($passwordCheck) || empty($user)){
    ...
    if($controlIngreso->searchUser($user)){
        if($password==$passwordCheck){
            $controlIngreso->updatePassword($user, $passHash);
