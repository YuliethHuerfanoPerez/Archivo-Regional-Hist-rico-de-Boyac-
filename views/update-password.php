			...
			<div class="row">
				...
				<div class="col-sm-6 col-sm-offset-3 wow fadeInDown animated" id="log" data-wow-delay=".1s">
                    <div class="title">
                        ...
                        <p>Por favor, ingrese su usuario y la contraseña nueva</p> 
                        <div class="t-box">
                            ...
                            <form action="" method="POST">
                                <div class="ajax-hidden">
                                    ...
                                    <div data-wow-delay=".1s" class="col-xs-6 col-sm-6 col-sm-offset-3 form-group wow fadeInUp animated">
                                        <label for="c_password" class="sr-only">Repetir contraseña</label>
                                        <input type="password" placeholder="Repetir contraseña" name="passwordnew" class="form-control" id="passwordnew"  required>
                                    </div>
                                    <button data-wow-delay=".3s" class="btn btn-primary btn-lg btn-ornge wow bounceIn animated" class="hbtn" type="submit" value="login">Actualizar</button>
                                </div>
...
<?php
include '../logic/ManageNewPassword.php';
#session_start();
$ManageNewPassword= new manageNewPassword();
$user = $_POST['user'];
...
if(empty($password) || empty($passwordCheck) || empty($user)){
    ...
    if($ManageNewPassword->searchUser($user)){
        if($password==$passwordCheck){
            $ManageNewPassword->updatePassword($user, $passHash);
            echo '<script language="javascript">alert("Se ha creado su nueva contraseña con éxito");</script>';
        }else{
            echo '<script language="javascript">alert("Las contraseñas no coinciden, intentelo de nuevo");</script>';
        }
    }else{
