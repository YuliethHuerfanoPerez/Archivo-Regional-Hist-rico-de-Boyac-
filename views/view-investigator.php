				...
				<div id="owl-demo" class="owl-carousel header1">
                    <div>
						<div class="col-xs-12 col-sm-6 col-md-6 header-text">
							<h2 class="wow bounceIn animated" data-wow-delay=".40s">En este momento no hay noticias disponibles</h2>
							<h3 class="wow bounceIn animated" data-wow-delay=".50s">:(</h3>
							<p class="wow bounceIn animated" data-wow-delay=".60s">Actualmente el Archivo Historico Regional de Boyacá no ha publicado novedades</p>
						</div>               
					</div>
				</div>				 
			</div>          
